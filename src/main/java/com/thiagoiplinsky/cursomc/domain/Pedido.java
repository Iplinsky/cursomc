...
public class Pedido implements Serializable {
	...
	@OneToOne(cascade=CascadeType.ALL, mappedBy="pedido") // Mapeamento 1-1
	...
	public String toString() {
		NumberFormat nf = NumberFormat.getCurrencyInstance(new Locale("pt", "BR"));  // Formatação numeral para dinheiro

...
public class DBService {
	...
	public void instantiateDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Thiago de Oliveira Iplinsky", "thiagoiplinsky@gmail.com", "90172005027",
				TipoCliente.PESSOA_FISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("995362741", "996538821"));
		cli1.addPerfil(Perfil.ADMIN);

		Cliente cli2 = new Cliente(null, "Ana Izabel Mendes Iplinsky", "anaiplinsky@gmail.com", "36378912377",
				TipoCliente.PESSOA_FISICA, pe.encode("123"));
